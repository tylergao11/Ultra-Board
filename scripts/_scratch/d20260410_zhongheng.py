    ...
    for d in days:
        ...
        if hit:
            ...
            print(
                ...
                f"价={hit.get('price')} 流通约{circ(hit)}亿 "
...
b = json.loads(Path(r"C:\Ai\Ultra-Board\tools\relay_study\out\daily_bars\000586.json").read_text(encoding="utf-8"))
print("==== 汇源日线 ====")
for k in ("2026-04-08", "2026-04-09", "2026-04-10", "2026-04-13"):
    print(k, b["bars"].get(k))
